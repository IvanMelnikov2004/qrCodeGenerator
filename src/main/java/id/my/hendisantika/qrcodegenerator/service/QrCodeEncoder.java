...
import java.util.Base64; // Импортируем стандартный Base64
...
public class QrCodeEncoder {
    ...
    private QrCodeProcessingResult generateImageAsBase64(String textToBeEncoded) {
        ...
        try {
            ...
            // Используем стандартный Base64 API для кодирования в строку
            imageText = "data:image/png;base64," + Base64.getEncoder().encodeToString(bytes);
